...
public class Tng_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_tng_, container, false);
        ...
        if (arguments != null) {
            ...
            Button next_btn = view.findViewById(R.id.enter_tng);

            next_btn.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(getActivity(), tngActivity.class);
